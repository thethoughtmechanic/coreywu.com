...
export function Navigation() {
  ...
  return (
    <>
      ...
      <div className={cn(
        "fixed top-16 right-0 h-[calc(100vh-4rem)] w-80 bg-soft-black/95 backdrop-blur-md border-l border-warm-brown/30 transform transition-transform duration-300 ease-in-out z-40 md:hidden shadow-2xl",
