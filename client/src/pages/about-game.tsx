  ...
  const [gameRounds, setGameRounds] = useState([
    ...
    },
    {
      ...
      allIcons: [
        ...
        { id: "4.3", name: "Crystal Ball", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="13" r="7" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6c-2 0-4 1-4 3m4-3c2 0 4 1 4 3M5 20h14a1 1 0 001-1v-1a1 1 0 00-1-1H5a1 1 0 00-1 1v1a1 1 0 001 1z" /><circle cx="9" cy="11" r="1" fill="currentColor" /><circle cx="15" cy="15" r="1" fill="currentColor" /></svg> },
