  ...
  const [gameRounds, setGameRounds] = useState([
    ...
    },
    {
      ...
      allIcons: [
        ...
        { id: "4.3", name: "Future", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 8l3-3m0 0v3m0-3h-3" /></svg> },
