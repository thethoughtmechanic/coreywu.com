  ...
  const [gameRounds, setGameRounds] = useState([
    {
      ...
      allIcons: [
        ...
        { id: "1.3", name: "Medal", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="15" r="4" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 11L10 2h4l2 9" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11L14 2h-4l-2 9" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 13v4" /></svg> },
