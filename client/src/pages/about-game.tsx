...
export default function AboutGame() {
  ...
  const [gameRounds, setGameRounds] = useState([
    ...
    },
    {
      ...
      allIcons: [
        { id: "2.1", name: "Technology", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 9l4-4 4 4m0 6l-4 4-4-4" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 13h6m-3 3v-6M8 13H2m3 3v-6" /></svg> },
        ...
        { id: "2.3", name: "Megaphone", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 18l4-2 8-4V6l-8-4-4-2v18zM8 18l-2 2 2-2zm0 0v-4" /></svg> },
