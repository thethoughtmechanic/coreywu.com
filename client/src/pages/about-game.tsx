...
export default function AboutGame() {
  ...
  const [gameRounds, setGameRounds] = useState([
    ...
    },
    {
      ...
      allIcons: [
        { id: "2.1", name: "Network", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="m8.5 8.5-5-5M15.5 8.5l5-5M8.5 15.5l-5 5M15.5 15.5l5 5" /><circle cx="4" cy="4" r="1" /><circle cx="20" cy="4" r="1" /><circle cx="4" cy="20" r="1" /><circle cx="20" cy="20" r="1" /></svg> },
    ...
    },
    {
      ...
      allIcons: [
        ...
        { id: "4.3", name: "Crystal Ball", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12c0-1.5 1.5-3 3-3s3 1.5 3 3-1.5 3-3 3-3-1.5-3-3zm12 0c0-1.5 1.5-3 3-3s3 1.5 3 3-1.5 3-3 3-3-1.5-3-3zm-6-6c0-1.5 1.5-3 3-3s3 1.5 3 3-1.5 3-3 3-3-1.5-3-3z" /></svg> },
