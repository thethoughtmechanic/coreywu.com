  ...
  const [gameRounds, setGameRounds] = useState([
    {
      ...
      allIcons: [
        ...
        { id: "1.3", name: "Connection", isCorrect: true, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" /></svg> },
        ...
        { id: "1.8", name: "Clock", isCorrect: false, svg: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6l4 2m6-8a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> }
      ]
    },
    {
      id: 2,
