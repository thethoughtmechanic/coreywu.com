...
export default function ExperimentsExperimental() {
  ...
  const ImagePlaceholder = ({ experiment }: { experiment: Experiment }) => {
    return (
      <div className="w-full h-48 bg-gradient-to-br from-warm-brown/10 to-light-brown/30 rounded-lg mb-4 flex flex-col items-center justify-center relative overflow-hidden">
        {/* Gradient overlay based on experiment type */}
        <div 
  ...
  // Desktop Card View (responsive columns) with image placeholders
  const DesktopView = () => (
  ...
  // Mobile Card View with image placeholders
  const MobileView = () => (
    <div className="min-h-[80vh] bg-gradient-to-br from-cream/30 to-light-brown/20 rounded-xl p-4 md:p-8">
      <div className="space-y-4">
      {orderedExperiments.map((experiment) => {
    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <header className="text-center mb-6 pt-4">
        ...
        <h1 className="text-4xl font-light text-warm-brown mb-6 text-center" data-testid="text-experiments-title">
          Experiments <span className="text-sm text-muted-grey">(with Image Previews)</span>
        </h1>
