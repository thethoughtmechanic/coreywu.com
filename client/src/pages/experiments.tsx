  ...
  const getCategoryIcon = (experimentId: string) => {
    ...
    if (['boyfriend-material-1', 'mister-misu-1', 'friday-home-1', 'lew-wu-1'].includes(experimentId)) {
      return (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <defs>
            <pattern id={`redSketch-${experimentId}`} patternUnits="userSpaceOnUse" width="4" height="4">
              <path d="M0,2 L4,2" stroke="#ef4444" strokeWidth="0.5" opacity="0.7"/>
              <path d="M0,3.5 L4,3.5" stroke="#ef4444" strokeWidth="0.5" opacity="0.5"/>
            </pattern>
          </defs>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" fill={`url(#redSketch-${experimentId})`} stroke="#ef4444" />
        </svg>
      );
    }
    ...
    if (experimentId === 'prompt-pulse-1') {
      return (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <defs>
            <pattern id={`yellowSketch-${experimentId}`} patternUnits="userSpaceOnUse" width="4" height="4">
              <path d="M1,1 L3,3" stroke="#eab308" strokeWidth="0.5" opacity="0.7"/>
              <path d="M0,3 L2,1" stroke="#eab308" strokeWidth="0.5" opacity="0.5"/>
              <path d="M2,0 L4,2" stroke="#eab308" strokeWidth="0.5" opacity="0.6"/>
            </pattern>
          </defs>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" fill={`url(#yellowSketch-${experimentId})`} stroke="#eab308" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" fill={`url(#yellowSketch-${experimentId})`} stroke="#eab308" />
        </svg>
      );
    }
    ...
    if (experimentId === 'food-for-thought-1') {
      return (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <defs>
            <pattern id={`purpleSketch-${experimentId}`} patternUnits="userSpaceOnUse" width="3" height="3">
              <circle cx="1.5" cy="1.5" r="0.3" fill="#a855f7" opacity="0.6"/>
              <path d="M0,1 L3,1" stroke="#a855f7" strokeWidth="0.3" opacity="0.4"/>
              <path d="M1,0 L1,3" stroke="#a855f7" strokeWidth="0.3" opacity="0.5"/>
            </pattern>
          </defs>
      ...
      <div className="flex justify-center items-center gap-6 mb-4">
        <div className="flex flex-col items-center gap-1 text-xs">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <defs>
              <pattern id="redSketch" patternUnits="userSpaceOnUse" width="4" height="4">
                <path d="M0,2 L4,2" stroke="#ef4444" strokeWidth="0.5" opacity="0.7"/>
                <path d="M0,3.5 L4,3.5" stroke="#ef4444" strokeWidth="0.5" opacity="0.5"/>
              </pattern>
            </defs>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" fill="url(#redSketch)" stroke="#ef4444" />
          </svg>
        ...
        <div className="flex flex-col items-center gap-1 text-xs">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <defs>
              <pattern id="yellowSketch" patternUnits="userSpaceOnUse" width="4" height="4">
                <path d="M1,1 L3,3" stroke="#eab308" strokeWidth="0.5" opacity="0.7"/>
                <path d="M0,3 L2,1" stroke="#eab308" strokeWidth="0.5" opacity="0.5"/>
                <path d="M2,0 L4,2" stroke="#eab308" strokeWidth="0.5" opacity="0.6"/>
              </pattern>
            </defs>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" fill="url(#yellowSketch)" stroke="#eab308" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" fill="url(#yellowSketch)" stroke="#eab308" />
          </svg>
        ...
        <div className="flex flex-col items-center gap-1 text-xs">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <defs>
              <pattern id="purpleSketch" patternUnits="userSpaceOnUse" width="3" height="3">
                <circle cx="1.5" cy="1.5" r="0.3" fill="#a855f7" opacity="0.6"/>
                <path d="M0,1 L3,1" stroke="#a855f7" strokeWidth="0.3" opacity="0.4"/>
                <path d="M1,0 L1,3" stroke="#a855f7" strokeWidth="0.3" opacity="0.5"/>
              </pattern>
            </defs>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" fill="url(#purpleSketch)" stroke="#a855f7" />
          </svg>
