        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-6 lg:gap-8 max-w-xs lg:max-w-none mx-auto">
          ...
          <Link href="/about">
            ...
            >
              ...
              <div className="relative z-10 text-center space-y-1 md:space-y-2 lg:space-y-4 flex-1 flex flex-col justify-center">
                <div className="w-8 h-8 md:w-10 md:h-10 lg:w-16 lg:h-16 bg-warm-brown rounded-full flex items-center justify-center mx-auto group-hover:scale-105 transition-transform duration-200 group-hover:bg-white/90">
                  <svg className="w-4 h-4 md:w-5 md:h-5 lg:w-8 lg:h-8 text-cream group-hover:text-warm-brown transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
                <h2 className="text-base md:text-lg lg:text-xl font-medium text-warm-brown group-hover:text-white group-hover:font-semibold transition-all duration-500">About Me</h2>
                <p className="hidden md:block lg:block text-soft-black/70 text-xs md:text-sm leading-relaxed group-hover:text-white/90 transition-all duration-500">
          ...
          <Link href="/thoughts">
            ...
            >
              ...
              <div className="relative z-10 text-center space-y-1 md:space-y-2 lg:space-y-4 flex-1 flex flex-col justify-center">
                ...
                <h2 className="text-base md:text-lg lg:text-xl font-medium text-warm-brown group-hover:text-white group-hover:font-semibold transition-all duration-500">Thoughts</h2>
                <p className="hidden md:block lg:block text-soft-black/70 text-xs md:text-sm leading-relaxed group-hover:text-white/90 transition-all duration-500">
          ...
          <Link href="/experiments">
            ...
            >
              ...
              <div className="relative z-10 text-center space-y-1 md:space-y-2 lg:space-y-4 flex-1 flex flex-col justify-center">
                ...
                <h2 className="text-base md:text-lg lg:text-xl font-medium text-warm-brown group-hover:text-white group-hover:font-semibold transition-all duration-500">Experiments</h2>
                <p className="hidden md:block lg:block text-soft-black/70 text-xs md:text-sm leading-relaxed group-hover:text-white/90 transition-all duration-500">
